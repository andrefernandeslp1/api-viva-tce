        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assinatura = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicosUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServicosUsuarios_Servicos_ServicoId",
                        column: x => x.ServicoId,
                        principalTable: "Servicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicosUsuarios_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicosUsuarios_ServicoId",
